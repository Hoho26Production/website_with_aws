      ...
      <div class="row">
            ...
            <div class="widget">
              ...
              <ul>
                ...
                <li><label><strong>Tautan : </strong></label>
                  <p>
                    IP Private (172.31.38.251)<br>IP Public (54.251.192.189)<br>Kode xxx-github-xxx
                  </p>
                </li>
              </ul>
            </div>
        ...
        <div class="span8">
          <div class="spacer30"></div>
			...
			{
			$user_name = $_POST["userdaftar"];
			$user_pass = $_POST["sandi1"];
			$sql = "INSERT INTO tb_admin (admin_user,admin_pass) VALUES ('$user_name', '$user_pass')";
				
				if ($konekkueri->query($sql) === TRUE)
				{
					?>
			<div class="alert alert-success" align="center">anggota baru sukses didaftarkan</div><h3 align="center" style="color: beige;"><a href="masuk.php">silahkan masuk</a> atau <a href="daftar.php">daftar</a></h3>
					<?php
				}
				else
				{
